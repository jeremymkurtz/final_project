...
export default function RoundRobin(props:{poolA: School[], poolB: School[]}){
        ...
        const pictures: {[key: string]: string} = {
            'SAN': '/src/client/assets/sanburg.png',
            'AND': '/src/client/assets/andrew.png',
            'NT': '/src/client/assets/newtrier.png',
            'DGN': '/src/client/assets/downersgrovenorth.png',
            'FR': '/src/client/assets/fremd.png',
            'HS': '/src/client/assets/hinsdale.png',
            'LT': '/src/client/assets/lockport.png',
            'NN': '/src/client/assets/napervillenorth.png',
            'DF': '/src/client/assets/deerfield.png',
            'YK': '/src/client/assets/york.png',
        }
                ...
                {group.map((team, index) => (
                    ...
                    >
                        ...
                        <div className="flex justify-center">
                            <img src={pictures[team.abbr]} alt={`${team.name} logo`} className="h-20 w-20"/>
                        </div>
